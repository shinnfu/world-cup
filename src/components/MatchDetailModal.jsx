    ...
    <div className="modal-backdrop" onClick={onClose} role="presentation">
      <section className="modal-card" onClick={(event) => event.stopPropagation()}>
        ...
        <div className="modal-match-overview">
          <button
            className={`modal-team-card modal-team-card-left ${currentUserVote?.predictedWinnerCode === match.team1Code ? "modal-team-card-active" : ""}`}
          ...
          <div className="modal-center">
            ...
            <span className="modal-vs-mark">VS</span>
          ...
          <button
            className={`modal-team-card modal-team-card-right ${currentUserVote?.predictedWinnerCode === match.team2Code ? "modal-team-card-active" : ""}`}
        ...
        <div className="modal-vote-meter" aria-hidden="true">
          <div className="modal-vote-meter-left" style={{ width: `${share.leftSlotRatio * 100}%` }} />
          <div className="modal-vote-meter-right" style={{ width: `${share.rightSlotRatio * 100}%` }} />
        </div>
